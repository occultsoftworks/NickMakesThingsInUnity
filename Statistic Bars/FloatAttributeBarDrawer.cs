...
using UnityEditor;
/// <summary>
/// Float attribute bar drawer.
/// </summary>
[CustomPropertyDrawer(typeof(FloatAttributeBar))]
public class FloatAttributeBarDrawer : PropertyDrawer {
	/// <summary>
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label){
		...
		//Draw Bar
		float current = property.FindPropertyRelative ("current").floatValue;
		float maximum = property.FindPropertyRelative ("max").floatValue;
